...
.subscribe((transformedPostData) =>{
  ...
  this.updatedPosts.next({posts:[...this.posts], postCount: transformedPostData.maxPosts});
});
}
...
getUsers(){
 return this.http.get<{message:string, user:any}>(backendUrl)
}
...
like(likes:number){
 return this.http.post(BACKEND_URL , likes)
}
